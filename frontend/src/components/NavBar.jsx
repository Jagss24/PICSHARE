    ...
    return (
        <div className='bg-blue-700 w-full h-16 flex justify-start items-center'>
            ...
            <div className=' ml-auto'>
                {userData ? (<IoMdLogOut className='text-3xl cursor-pointer text-blue-600 mr-4 bg-white rounded-md hover:text-red-600' onClick={handleLogOut} />) : (<Link className='p-2 rounded-lg cursor-pointer mr-3 text-blue-700 bg-white font-sans hover:text-black' to='/signin'>Sign In</Link>)}
